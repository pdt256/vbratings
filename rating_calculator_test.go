...
func Test_RatingCalculator_CalculateRatingsByYear_SingleMatch(t *testing.T) {
	...
	// Then
	playerRatingA := playerRatingRepository.GetPlayerRatingByYear(1, 2018)
	playerRatingB := playerRatingRepository.GetPlayerRatingByYear(2, 2018)
	playerRatingC := playerRatingRepository.GetPlayerRatingByYear(3, 2018)
	playerRatingD := playerRatingRepository.GetPlayerRatingByYear(4, 2018)
...
//	playerRatingC := playerRatingRepository.GetPlayerRatingByYear(3, 2018)
//	playerRatingD := playerRatingRepository.GetPlayerRatingByYear(4, 2018)
//	assertPlayerRating(t, playerRatingA, 1600, 1616, 2018)
//	assertPlayerRating(t, playerRatingB, 1500, 1516, 2018)
//	assertPlayerRating(t, playerRatingC, 1500, 1484, 2018)
//	assertPlayerRating(t, playerRatingD, 1500, 1484, 2018)
//}
